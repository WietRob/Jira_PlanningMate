...
var svg = function svg(_ref, colorMode) {
  ...
  if ((0, _platformFeatureFlags.getBooleanFF)('platform.design-system-team.brand-refresh-update-product-logos_q7coo')) {
    ...
    return "<svg viewBox=\"0 0 32 32\" focusable=\"false\" aria-hidden=\"true\" height=\"32\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n      <path d=\"M25.52 25.727c0-3.604-2.949-6.517-6.517-6.517h-6.007v-5.497H6.48v10.813c0 .837.364 1.201 1.201 1.201zM6.48 6.687c0 3.604 2.876 6.517 6.48 6.517h6.043V18.7h6.517V7.888q0-1.2-1.201-1.201z\" fill=\"".concat(colors.iconColor, "\"/>\n    </svg>");
  } else {
    if (appearance) {
