...
var _colors2 = require("@atlaskit/theme/colors");
...
var svg = function svg(_ref, colorMode) {
  ...
  if ((0, _platformFeatureFlags.getBooleanFF)('platform.design-system-team.brand-refresh-update-product-logos_q7coo')) {
    ...
    var _colors = {
      ...
      iconGradientMid: _colors2.B400,
      // eslint-disable-next-line @atlaskit/design-system/ensure-design-token-usage
      iconGradientStop: _colors2.B400
    };
