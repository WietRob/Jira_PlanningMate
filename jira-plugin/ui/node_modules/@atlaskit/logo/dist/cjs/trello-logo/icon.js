...
var svg = function svg(_ref, colorMode) {
  ...
  if ((0, _platformFeatureFlags.getBooleanFF)('platform.design-system-team.brand-refresh-update-product-logos_q7coo')) {
    // Currently the user can style the trello icon using only iconGradientStop and iconGradientStart
 ...
 */
var TrelloIcon = exports.TrelloIcon = function TrelloIcon(_ref2) {
